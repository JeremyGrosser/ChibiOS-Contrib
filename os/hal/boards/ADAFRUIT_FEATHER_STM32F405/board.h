...
/*
 * Setup for Adafruit Feather STM32F405 Express board.
 */

/*
 * Board identifier.
 */
#define BOARD_ADAFRUIT_FEATHER_STM32F405
#define BOARD_NAME                  "Adafruit Feather STM32F405 Express"
...
#define GPIOB_RX                    11U
#define GPIOB_D0                    11U
#define GPIOB_SD_DETECT             12U
#define GPIOB_SCK                   13U
#define GPIOB_MISO                  14U
#define GPIOB_MOSI                  15U

#define GPIOC_D8                    0U
#define GPIOC_NEOPIX                0U
#define GPIOC_D13                   1U
#define GPIOC_D12                   2U
#define GPIOC_D11                   3U
#define GPIOC_A4                    4U
 ...
 */
#define LINE_V_DIV                  PAL_LINE(GPIOA, 3U)
#define LINE_A0                     PAL_LINE(GPIOA, 4U)
#define LINE_A1                     PAL_LINE(GPIOA, 5U)
#define LINE_A2                     PAL_LINE(GPIOA, 6U)
#define LINE_A3                     PAL_LINE(GPIOA, 7U)
...
#define LINE_FLASH_CS               PAL_LINE(GPIOA, 15U)
...
#define LINE_D9                     PAL_LINE(GPIOB, 8U)
#define LINE_D10                    PAL_LINE(GPIOB, 9U)
#define LINE_TX                     PAL_LINE(GPIOB, 10U)
#define LINE_D1                     PAL_LINE(GPIOB, 10U)
#define LINE_RX                     PAL_LINE(GPIOB, 11U)
#define LINE_D0                     PAL_LINE(GPIOB, 11U)
#define LINE_SD_DETECT              PAL_LINE(GPIOB, 12U)
#define LINE_SCK                    PAL_LINE(GPIOB, 13U)
#define LINE_MISO                   PAL_LINE(GPIOB, 14U)
#define LINE_MOSI                   PAL_LINE(GPIOB, 15U)
#define LINE_D8                     PAL_LINE(GPIOC, 0U)
#define LINE_NEOPIX                 PAL_LINE(GPIOC, 0U)
#define LINE_D13                    PAL_LINE(GPIOC, 1U)
#define LINE_D12                    PAL_LINE(GPIOC, 2U)
#define LINE_D11                    PAL_LINE(GPIOC, 3U)
#define LINE_A4                     PAL_LINE(GPIOC, 4U)
#define LINE_A5                     PAL_LINE(GPIOC, 5U)
#define LINE_D6                     PAL_LINE(GPIOC, 6U)
#define LINE_D5                     PAL_LINE(GPIOC, 7U)
 ...
 * PA15 - FLASH_CS                  (alternate 6).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_PIN0) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN1) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN2) |           \
                                     PIN_MODE_ANALOG(GPIOA_V_DIV) |         \
                                     PIN_MODE_INPUT(GPIOA_A0) |             \
                                     PIN_MODE_INPUT(GPIOA_A1) |             \
                                     PIN_MODE_INPUT(GPIOA_A2) |             \
                                     PIN_MODE_INPUT(GPIOA_A3) |             \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_V_DIV) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_A0) |         \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_PIN0) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOA_V_DIV) |         \
                                     PIN_OSPEED_HIGH(GPIOA_A0) |            \
                                     PIN_OSPEED_HIGH(GPIOA_A1) |            \
                                     PIN_OSPEED_HIGH(GPIOA_A2) |            \
                                     PIN_OSPEED_HIGH(GPIOA_A3) |            \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_PIN0) |         \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_V_DIV) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_A0) |           \
                                     PIN_PUPDR_PULLUP(GPIOA_A1) |           \
                                     PIN_PUPDR_PULLUP(GPIOA_A2) |           \
                                     PIN_PUPDR_PULLUP(GPIOA_A3) |           \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOA_V_DIV) |            \
                                     PIN_ODR_HIGH(GPIOA_A0) |               \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_PIN0, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOA_V_DIV, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_A0, 0U) |            \
                                     PIN_AFIO_AF(GPIOA_A1, 0U) |            \
                                     PIN_AFIO_AF(GPIOA_A2, 0U) |            \
                                     PIN_AFIO_AF(GPIOA_A3, 0U))
 ...
 * PB3  - FLASH_SCK                 (alternate 6).
 * PB4  - FLASH_MISO                (alternate 6).
 * PB5  - FLASH_MOSI                (alternate 6).
 * PB6  - SCL                       (alternate 4).
 * PB7  - SDA                       (alternate 4).
 * PB8  - D9                        (input pullup).
 * PB9  - D10                       (input pullup).
 * PB10 - TX D1                     (alternate 7).
 * PB11 - RX D0                     (alternate 7).
 * PB12 - SD_DETECT                 (input pullup).
 * PB13 - SCK                       (alternate 5).
 * PB14 - MISO                      (alternate 5).
 * PB15 - MOSI                      (alternate 5).
 */
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_PIN0) |           \
                                     PIN_MODE_INPUT(GPIOB_PIN1) |           \
                                     PIN_MODE_INPUT(GPIOB_PIN2) |           \
                                     PIN_MODE_ALTERNATE(GPIOB_FLASH_SCK) |  \
                                     PIN_MODE_ALTERNATE(GPIOB_FLASH_MISO) | \
                                     PIN_MODE_ALTERNATE(GPIOB_FLASH_MOSI) | \
                                     PIN_MODE_ALTERNATE(GPIOB_SCL) |        \
                                     PIN_MODE_ALTERNATE(GPIOB_SDA) |        \
                                     PIN_MODE_INPUT(GPIOB_D9) |             \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_D9) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOB_D10) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOB_TX) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOB_RX) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOB_SD_DETECT) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOB_SCK) |        \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_PIN0) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_FLASH_MOSI) |    \
                                     PIN_OSPEED_HIGH(GPIOB_SCL) |           \
                                     PIN_OSPEED_HIGH(GPIOB_SDA) |           \
                                     PIN_OSPEED_HIGH(GPIOB_D9) |            \
                                     PIN_OSPEED_HIGH(GPIOB_D10) |           \
                                     PIN_OSPEED_HIGH(GPIOB_TX) |            \
                                     PIN_OSPEED_HIGH(GPIOB_RX) |            \
                                     PIN_OSPEED_HIGH(GPIOB_SD_DETECT) |     \
                                     PIN_OSPEED_HIGH(GPIOB_SCK) |           \
                                     PIN_OSPEED_HIGH(GPIOB_MISO) |          \
                                     PIN_OSPEED_HIGH(GPIOB_MOSI))
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_PIN0) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN1) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN2) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_FLASH_SCK) |    \
                                     PIN_PUPDR_PULLUP(GPIOB_FLASH_MISO) |   \
                                     PIN_PUPDR_PULLUP(GPIOB_FLASH_MOSI) |   \
                                     PIN_PUPDR_FLOATING(GPIOB_SCL) |        \
                                     PIN_PUPDR_FLOATING(GPIOB_SDA) |        \
                                     PIN_PUPDR_PULLUP(GPIOB_D9) |           \
                                     PIN_PUPDR_PULLUP(GPIOB_D10) |          \
                                     PIN_PUPDR_PULLUP(GPIOB_TX) |           \
                                     PIN_PUPDR_PULLUP(GPIOB_RX) |           \
                                     PIN_PUPDR_PULLUP(GPIOB_SD_DETECT) |    \
                                     PIN_PUPDR_FLOATING(GPIOB_SCK) |        \
                                     PIN_PUPDR_FLOATING(GPIOB_MISO) |       \
                                     PIN_PUPDR_FLOATING(GPIOB_MOSI))
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_PIN0) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN1) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOB_FLASH_SCK) |        \
                                     PIN_ODR_HIGH(GPIOB_FLASH_MISO) |       \
                                     PIN_ODR_HIGH(GPIOB_FLASH_MOSI) |       \
                                     PIN_ODR_HIGH(GPIOB_SCL) |              \
                                     PIN_ODR_HIGH(GPIOB_SDA) |              \
                                     PIN_ODR_HIGH(GPIOB_D9) |               \
                                     PIN_ODR_HIGH(GPIOB_D10) |              \
                                     PIN_ODR_HIGH(GPIOB_TX) |               \
                                     PIN_ODR_HIGH(GPIOB_RX) |               \
                                     PIN_ODR_HIGH(GPIOB_SD_DETECT) |        \
                                     PIN_ODR_HIGH(GPIOB_SCK) |              \
                                     PIN_ODR_HIGH(GPIOB_MISO) |             \
                                     PIN_ODR_HIGH(GPIOB_MOSI))
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_PIN0, 0U) |          \
                                     PIN_AFIO_AF(GPIOB_PIN1, 0U) |          \
                                     PIN_AFIO_AF(GPIOB_PIN2, 0U) |          \
                                     PIN_AFIO_AF(GPIOB_FLASH_SCK, 6U) |     \
                                     PIN_AFIO_AF(GPIOB_FLASH_MISO, 6U) |    \
                                     PIN_AFIO_AF(GPIOB_FLASH_MOSI, 6U) |    \
                                     PIN_AFIO_AF(GPIOB_SCL, 4U) |           \
                                     PIN_AFIO_AF(GPIOB_SDA, 4U))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_D9, 0U) |            \
                                     PIN_AFIO_AF(GPIOB_D10, 0U) |           \
                                     PIN_AFIO_AF(GPIOB_TX, 7U) |            \
                                     PIN_AFIO_AF(GPIOB_RX, 7U) |            \
                                     PIN_AFIO_AF(GPIOB_SD_DETECT, 0U) |     \
                                     PIN_AFIO_AF(GPIOB_SCK, 5U) |           \
                                     PIN_AFIO_AF(GPIOB_MISO, 5U) |          \
                                     PIN_AFIO_AF(GPIOB_MOSI, 5U))

/*
 * GPIOC setup:
 *
 * PC0  - D8 NEOPIX                 (output pushpull maximum).
 * PC1  - D13                       (input pullup).
 * PC2  - D12                       (input pullup).
 * PC3  - D11                       (input pullup).
 * PC4  - A4                        (input pullup).
 * PC5  - A5                        (input pullup).
 * PC6  - D6                        (input pullup).
 * PC7  - D5                        (input pullup).
 ...
 */
#define VAL_GPIOC_MODER             (PIN_MODE_OUTPUT(GPIOC_D8) |            \
                                     PIN_MODE_INPUT(GPIOC_D13) |            \
                                     PIN_MODE_INPUT(GPIOC_D12) |            \
                                     PIN_MODE_INPUT(GPIOC_D11) |            \
                                     PIN_MODE_INPUT(GPIOC_A4) |             \
                                     PIN_MODE_INPUT(GPIOC_A5) |             \
                                     PIN_MODE_INPUT(GPIOC_D6) |             \
                                     PIN_MODE_INPUT(GPIOC_D5) |             \
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_D8) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOC_D13) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOC_D12) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOC_D11) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOC_A4) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOC_A5) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOC_D6) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOC_D5) |         \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_D8) |            \
                                     PIN_OSPEED_HIGH(GPIOC_D13) |           \
                                     PIN_OSPEED_HIGH(GPIOC_D12) |           \
                                     PIN_OSPEED_HIGH(GPIOC_D11) |           \
                                     PIN_OSPEED_HIGH(GPIOC_A4) |            \
                                     PIN_OSPEED_HIGH(GPIOC_A5) |            \
                                     PIN_OSPEED_HIGH(GPIOC_D6) |            \
                                     PIN_OSPEED_HIGH(GPIOC_D5) |            \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_D8) |           \
                                     PIN_PUPDR_PULLUP(GPIOC_D13) |          \
                                     PIN_PUPDR_PULLUP(GPIOC_D12) |          \
                                     PIN_PUPDR_PULLUP(GPIOC_D11) |          \
                                     PIN_PUPDR_PULLUP(GPIOC_A4) |           \
                                     PIN_PUPDR_PULLUP(GPIOC_A5) |           \
                                     PIN_PUPDR_PULLUP(GPIOC_D6) |           \
                                     PIN_PUPDR_PULLUP(GPIOC_D5) |           \
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_D8) |               \
                                     PIN_ODR_HIGH(GPIOC_D13) |              \
                                     PIN_ODR_HIGH(GPIOC_D12) |              \
                                     PIN_ODR_HIGH(GPIOC_D11) |              \
                                     PIN_ODR_HIGH(GPIOC_A4) |               \
                                     PIN_ODR_HIGH(GPIOC_A5) |               \
                                     PIN_ODR_HIGH(GPIOC_D6) |               \
                                     PIN_ODR_HIGH(GPIOC_D5) |               \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_D8, 0U) |            \
                                     PIN_AFIO_AF(GPIOC_D13, 0U) |           \
                                     PIN_AFIO_AF(GPIOC_D12, 0U) |           \
                                     PIN_AFIO_AF(GPIOC_D11, 0U) |           \
                                     PIN_AFIO_AF(GPIOC_A4, 0U) |            \
                                     PIN_AFIO_AF(GPIOC_A5, 0U) |            \
                                     PIN_AFIO_AF(GPIOC_D6, 0U) |            \
                                     PIN_AFIO_AF(GPIOC_D5, 0U))
